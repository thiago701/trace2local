 ...
 * (ADR-007 / SPEC §8.3). Substituto literal: {@code [TRACE2LOCAL_REDACTED]}.
 *
...
public final class Redactor {
    ...
    public static final String REDACTED = "[TRACE2LOCAL_REDACTED]";
    public static final String TRUNCATED = "[TRACE2LOCAL_TRUNCATED]";
