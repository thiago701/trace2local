...
class MutationIngestReceiverTest {
    ...
    void fusesIncomingMutationsWithSpans() throws Exception {
        ...
        try (TraceVantaPipeline pipeline = TraceVantaPipeline.start(cfg)) {
            ...
            http.createContext("/tvingest/v1/mutations", new MutationIngestReceiver(pipeline));
            ...
            try {
                ...
                HttpResponse<String> response = HttpClient.newHttpClient().send(HttpRequest.newBuilder()
                                .uri(URI.create("http://127.0.0.1:" + http.getAddress().getPort() + "/tvingest/v1/mutations"))
