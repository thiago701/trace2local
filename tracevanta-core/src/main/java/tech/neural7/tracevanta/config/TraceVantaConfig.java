...
public record TraceVantaConfig(
    ...
    public static TraceVantaConfig defaults() {
    ...
    public static final class Builder {
        ...
        public TraceVantaConfig build() {
            return new TraceVantaConfig(enabled, basePath, port, bindAddress, allowNonLoopback,
