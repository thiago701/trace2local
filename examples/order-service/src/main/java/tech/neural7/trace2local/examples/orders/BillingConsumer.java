...
public class BillingConsumer implements AutoCloseable {
    ...
    public BillingConsumer(SqsClient sqs, OrderService orderService,
        ...
        this.worker = new Thread(this::loop, "trace2local-demo-billing-consumer");
    ...
    private void process(Message message) {
        ...
        var tracer = Trace2LocalOtel.get().getTracer("tech.neural7.trace2local:demo-consumer");
        io.opentelemetry.api.trace.SpanBuilder builder = tracer.spanBuilder("Sqs.ReceiveMessage")
                ...
                .setAttribute(tech.neural7.trace2local.otel.OtelAttributeNames.MESSAGING_SYSTEM, "aws.sqs")
                .setAttribute(tech.neural7.trace2local.otel.OtelAttributeNames.MESSAGING_DESTINATION, "billing-queue");
        if (remote != null) {
            // continua o trace do produtor: o @Trace2Local do BillOrder fica FILHO
