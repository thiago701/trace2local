...
class StoryServiceTest {
    ...
    void errorStepIsMarkedAndConclusionReflectsFailure() {
        Node failing = new Node("s1", null, NodeKind.BUSINESS, "ConfirmOrder", NodeStatus.ERROR,
                ...
                new tech.neural7.trace2local.model.ErrorInfo("E", "condição falhou", null), List.of());
    ...
    private static Execution sample() {
        Node root = new Node("root", null, NodeKind.HTTP_SERVER, "POST /orders", NodeStatus.OK,
                ...
                Map.of(tech.neural7.trace2local.otel.OtelAttributeNames.HTTP_METHOD, "POST",
                        tech.neural7.trace2local.otel.OtelAttributeNames.HTTP_ROUTE, "/orders",
        ...
        Node dynamo = new Node("d1", "b1", NodeKind.DYNAMODB, "DynamoDB: orders", NodeStatus.OK,
                ...
                Map.of(tech.neural7.trace2local.otel.OtelAttributeNames.AWS_DYNAMO_TABLES, "orders",
                        tech.neural7.trace2local.otel.OtelAttributeNames.RPC_METHOD, "PutItem"),
                null,
        ...
        Node sns = new Node("s1", "b1", NodeKind.SNS, "SNS: order-events", NodeStatus.OK,
                ...
                Map.of(tech.neural7.trace2local.otel.OtelAttributeNames.AWS_SNS_TOPIC,
                        "arn:aws:sns:us-east-1:000000000000:order-events",
                        tech.neural7.trace2local.otel.OtelAttributeNames.RPC_METHOD, "Publish"),
                null, null, null, List.of());
