 ...
 */
public class TraceVantaWebFilter extends OncePerRequestFilter {

    static final String ATTR_PAYLOAD_REQUEST = "tv.payload.request";
    static final String ATTR_PAYLOAD_RESPONSE = "tv.payload.response";

    private final TraceVantaConfig cfg;

    public TraceVantaWebFilter(TraceVantaConfig cfg) {
        this.cfg = cfg;
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        Tracer tracer = tech.neural7.tracevanta.otel.TraceVantaOtel.get().getTracer("tech.neural7.tracevanta:http");
        Context extracted = tech.neural7.tracevanta.otel.TraceVantaOtel.get().getPropagators()
    ...
    static String captureBody(byte[] bytes, TraceVantaConfig cfg) {
        try {
