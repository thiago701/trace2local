 ...
 * {@code AWS_LAMBDA_FUNCTION_NAME} ⇒ Companion; {@code tracevanta.station.endpoint}
 ...
 */
public class TraceVantaEmbeddedModeCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        String station = context.getEnvironment().getProperty("tracevanta.station.endpoint");
