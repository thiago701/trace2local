...
/**
 * Propriedades {@code trace2local.*} (SPEC §5.4). A resolução em cascata
 ...
 * match relaxed de caminho dotted ({@code trace2local.redaction.mode}) para
 ...
 */
@ConfigurationProperties(prefix = "trace2local")
public class Trace2LocalProperties {
    ...
    /** Porta do servidor Trace2Local; 0 = efêmera. */
