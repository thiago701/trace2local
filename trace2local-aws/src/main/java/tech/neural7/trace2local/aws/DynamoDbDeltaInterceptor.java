...
import tech.neural7.trace2local.internal.DeltaCalculator;
 ...
 * {@code trace2local.aws.dynamodb.capture-before=false} e ativa apenas em perfil
...
public final class DynamoDbDeltaInterceptor implements ExecutionInterceptor {
    ...
    static final software.amazon.awssdk.core.interceptor.ExecutionAttribute<Boolean> TV_ELEVATED =
            new software.amazon.awssdk.core.interceptor.ExecutionAttribute<>("trace2local.aws.dynamodb.elevated");
     ...
     * {@link Trace2LocalAws#instrumentWithReadBack}.
     */
    @FunctionalInterface
    ...
    public DynamoDbDeltaInterceptor(Trace2LocalConfig cfg) {
        this(cfg, null);
    }

    public DynamoDbDeltaInterceptor(Trace2LocalConfig cfg, UpdateReadBack readBack) {
    ...
    public SdkResponse modifyResponse(Context.ModifyResponse context, ExecutionAttributes executionAttributes) {
        ...
        //    Trace2Local pediu — restaurando a semântica original do ReturnValues=NONE.
        //    Só restaura quando FOI o Trace2Local quem elevou; se o dev pediu os
