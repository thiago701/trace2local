...
class DynamoDbDeltaInterceptorTest {
    ...
    private DynamoDbDeltaInterceptor interceptor() {
        return new DynamoDbDeltaInterceptor(Trace2LocalConfig.defaults());
    }

    private DynamoDbDeltaInterceptor interceptorNoCapture() {
        return new DynamoDbDeltaInterceptor(Trace2LocalConfig.builder().dynamoDbCaptureBefore(false).build());
    }
    ...
    void capturesPutItemDeltaAndRestoresResponseInTheSamePhase() {
        ...
        assertThat(mutation.deltas()).extracting(tech.neural7.trace2local.model.FieldDelta::path)
    ...
    void capturesUpdateItemBeforeAndAfterExactWithReadBack() {
        ...
        var interceptor = new DynamoDbDeltaInterceptor(Trace2LocalConfig.defaults(),
