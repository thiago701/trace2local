...
class JsonCodecTest {
    ...
    void serializesTvemRecords() throws Exception {
        var execution = new tech.neural7.tracevanta.model.Execution("TV-1", "trace", 
                tech.neural7.tracevanta.model.ExecutionStatus.COMPLETED,
                tech.neural7.tracevanta.model.Trigger.UI_DISPATCH,
                Instant.parse("2026-09-18T10:00:00Z"), Duration.ofMillis(42),
                java.util.List.of(), tech.neural7.tracevanta.model.ExecutionMetrics.EMPTY, java.util.List.of());
